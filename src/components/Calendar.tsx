...
const Calendar: React.FC = () => {
    ...
    return (
        <>
            ...
            />
            <div>
                <Dialog open={open} onClose={handleClose} scroll="paper" aria-labelledby="scroll-modal-title" aria-describedby="scroll-modal-description">
                    <DialogContent dividers>
                        <Typography id="modal-modal-title" variant="h6" component="h2">
                            Volunteer
                        </Typography>
                        <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                            Available volunteer opportunities with us. Please be sure you have read our <a href="#">expectaions</a> and <a href="#">FAQs</a>{' '}
                            about volunteering.
                        </Typography>
                        <div style={{ overflow: 'hidden' }}>
                            ...
                            <Accordion>
                                ...
                                <AccordionDetails>
                                    <Typography>We could use a hand in our office making calls.</Typography>
                                    <Box sx={{ mt: 3, ml: 1, mb: 1 }}>
                                        <Button onClick={handleOpenDisclaimer}>confirm</Button>
                                    </Box>
                                </AccordionDetails>
            ...
            <div>
                <Dialog fullScreen open={openDisclaimer} onClose={handleCloseDisclaimer}>
                    <AppBar sx={{ position: 'relative' }}>
                        <Toolbar>
                            <IconButton edge="start" color="inherit" onClick={handleCloseDisclaimer} aria-label="close">
                                <CloseIcon />
                            </IconButton>
                    ...
                    <Typography>Please notify our team at least 48 hours in advance if you are no longer available.</Typography>
                    <List>
                        <ListItemButton>
                        ...
                        <Divider />
                        <ListItemButton>
                            <ListItemText primary="Process donation" secondary="2024-03-21 @ 12:15 PM" />
                        </ListItemButton>
                    </List>
                </Dialog>
            </div>
