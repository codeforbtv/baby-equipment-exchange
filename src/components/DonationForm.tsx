...
export default function DonationForm(props: DonationFormProps) {
    ...
    const { addPendingDonation, pendingDonations } =
        ...
        if (images) {
            for (let i = 0; i < images.length; i++) {
                const imagePreview = (
                    <ImageThumbnail
                        key={i}
                        removeFromState={(fileToRemove: File) =>
                            removeImageFromState(
                                images,
                                setImages,
                                fileToRemove
        ...
        <>
            ...
            {!isLoading && !categories && (
                <Typography variant="body1">
                    Could not load donation form. Please try again later.
                </Typography>
            )}
            {!isLoading && categories && (
                    ...
                    >
                        ...
                        <Box className={styles['form__section--bottom']}>
                            <Button
                                ...
                                size="medium"
                                type="button"
                                onClick={handleAddPendingDonation}
                                disabled={isDisabled}
                            >
                                Add item
                            </Button>
